...
namespace Unity.Behavior.GraphFramework
{
    ...
    public struct SerializableGUID : IEquatable<SerializableGUID>
    {
        ...
        {
            return left.m_Value0 == right.m_Value0 && left.m_Value1 == right.m_Value1;
        }
        ...
        long m_Value0Signed
        {
            get => (long)m_Value0 + long.MinValue;
            set => m_Value0 = (ulong)(value - long.MinValue);
        }

        [Preserve]
        long m_Value1Signed
        {
            get => (long)m_Value1 + long.MinValue;
            set => m_Value1 = (ulong)(value - long.MinValue);
        }
        ...
        /// </summary>
        /// <param name="hash">The hash used to initialize the SerializableGUID.</param>
